...
<a target='_blank'
  href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/6140884041559179264?project=gp-ct-sbox-sat-gcp0bg-darksoft&deploy=true'>
  Vertex AI Studio
...
<ul style="list-style-position: outside; margin-left: 1em;">
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-bluntchat-1-1763679274101/source?project=gp-ct-sbox-sat-gcp0bg-darksoft'
    >
      source code editor
  ...
  <li>Go to your
    <a target='_blank'
       href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/6140884041559179264?project=gp-ct-sbox-sat-gcp0bg-darksoft'
    >
  ...
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-bluntchat-1-1763679274101/security?project=gp-ct-sbox-sat-gcp0bg-darksoft'
    >
      Security settings
